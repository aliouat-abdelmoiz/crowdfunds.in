                ...
                @foreach($subcat as $subcategory)
                    <article class="col-md-4 image-list add-margin add-border-bottom pageitem">
                        <a href="/jobs/{{ \App\Category::find($subcategory->category->id)->name }}/{{ $subcategory->name }}">
                            ...
                            <img class="thumbimg" src="{{ !isset($subcategory->image)||$subcategory->image == '' ? '/images/no-logo.png' : 'https://admin.yourserviceconnection.com/upload/subcategories/images/thumbs/' . $subcategory->image }} " alt=""/>
                        </a>
